...
{
    class MaterialIssuesBL : BusinessBase
    {
        Exception mException = null;
        string mErrorMsg = "";

        public MaterialIssuesBL()
        {
            this.Exception = null;
            this.ErrorMessage = "";
            mException = null;
        ...
        public void Insert(string IsreturnYESNO,  string code ,long ItemID, int GodownID, int emp1, int emp2, string reason, string narration, int Isreturnable, string itemcode, decimal QOH, decimal IssueQTY)
        {
            SetDefaultException();
            ...
            para.Add("@i_reason", reason.ToString());
            para.Add("@i_narration", narration.ToString());
            para.Add("@i_returnable", Isreturnable.ToString());
            para.Add("@i_IsreturnYESNO", IsreturnYESNO.ToString());
            ...
            objDA.ExecuteSP("usp_MatearialIssue_Insert", para, true, ref mException, ref mErrorMsg, "MatearialIssue - Insert");
        ...
        public void Update(string IsreturnYESNO, string code, long MaterialID, long ItemID, int GodownID, int emp1, int emp2, string reason, string narration, int Isreturnable, string itemcode, decimal QOH, decimal IssueQTY)
        {
            SetDefaultException();
            NameValueCollection para = new NameValueCollection();
            ...
            objDA.ExecuteSP("usp_MatearialIssue_Update", para, true, ref mException, ref mErrorMsg, "MatearialIssue - Update");
