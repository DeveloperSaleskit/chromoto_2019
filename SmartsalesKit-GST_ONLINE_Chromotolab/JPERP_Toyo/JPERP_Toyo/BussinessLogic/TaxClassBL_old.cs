...
namespace Account.BusinessLogic
{
    class TaxClassBL : BusinessBase
    {
        ...
        public void Insert(string TaxClass,DateTime FromDate,decimal Excise,decimal VAT, decimal ServiceTax,decimal EduCess,decimal HEduCess,decimal CST,decimal AVAT)
        {
            SetDefaultException();
        ...
        public void Update(long TaxClassID,string TaxClass, DateTime FromDate,decimal Excise,decimal VAT, decimal ServiceTax, decimal EduCess, decimal HEduCess, decimal CST,decimal AVAT)
        {
            SetDefaultException();
            NameValueCollection para = new NameValueCollection();
