...
namespace Account.BusinessLogic
{
    class TaxClassBL : BusinessBase
    {
        ...
        public void Insert(decimal SGST, decimal CGST, decimal IGST, string TaxClass, DateTime FromDate, decimal Excise, decimal VAT, decimal ServiceTax, decimal EduCess, decimal HEduCess, decimal CST, decimal AVAT, decimal SBCess, string ExtraTaxType, decimal ExtraTax)
        {
            SetDefaultException();
            NameValueCollection para = new NameValueCollection();

            para.Add("@i_SGST", SGST.ToString());
            para.Add("@i_CGST", CGST.ToString());
            para.Add("@i_IGST", IGST.ToString());
        ...
        public void Update(decimal SGST, decimal CGST, decimal IGST, long TaxClassID, string TaxClass, DateTime FromDate, decimal Excise, decimal VAT, decimal ServiceTax, decimal EduCess, decimal HEduCess, decimal CST, decimal AVAT, decimal SBCess, string ExtraTaxType, decimal ExtraTax)
        {
            SetDefaultException();
            NameValueCollection para = new NameValueCollection();
