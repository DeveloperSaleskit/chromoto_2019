...
{
    class SalesReturnBL : BusinessBase
    {
        ...
        public Int32 Insert(string SalesCode, DateTime SIDate,  long CustomerID, long DueDays, decimal ServiceAmount,
             decimal TotalAmount, decimal ExciseAmount, decimal EduCessAmount, decimal HEduCessAmount, decimal AmountAfterExcise,
            decimal CSTAmount, decimal VATAmount, decimal AVATAmount, decimal Discount, decimal NetAmount, decimal PaidAmount, string Narration,
            string XmlString, Int64 Cnt, string XmlString1, Int64 Cnt1,
            Int16 AttendedBy, decimal ExtraCharges, string ExtraChargesType, string TIN, Int16 RecDay, string Type, string ShippingAdd,
            ...
            decimal ExtraCharges3, string ExtraChargesType3,
             Int16 EmpAllToID, bool IsPaid, decimal TotalDiscAmt, int CompId, int GodownId)
        {
            SetDefaultException();
            Int32 POID = 0;
        ...
        public void Update(long SIID, string SalesCode, DateTime SIDate, long CustomerID, long DueDays, decimal ServiceAmount,
             decimal TotalAmount, decimal ExciseAmount, decimal EduCessAmount, decimal HEduCessAmount, decimal AmountAfterExcise,
            decimal CSTAmount, decimal VATAmount, decimal AVATAmount, decimal Discount, decimal NetAmount, decimal PaidAmount, string Narration,
            string XmlString, Int64 Cnt, string XmlString1, Int64 Cnt1,
            Int16 AttendedBy, decimal ExtraCharges, string ExtraChargesType, string TIN, Int16 RecDay, string Type, string ShippingAdd,
