...
namespace Account.BusinessLogic
{
    class CompanyInfoBL : BusinessBase
    {
        ...
        public void Insert_CompanyInfo_Detail(string CompanyName, string BusinessLine, string Address1, string Address2, string State, string City,
           ...
           string Value5, string Value6, string Com_Profile, string RPath, string DPath, string ServerIP, string UserName, string Password, string FtpReportPath)
        {
            SetDefaultException();
            ...
            para.Add("@i_ServerIP", ServerIP);
            para.Add("@i_UserName", UserName);
            para.Add("@i_Password", Password);
            para.Add("@i_FTPReportPath", FtpReportPath);
