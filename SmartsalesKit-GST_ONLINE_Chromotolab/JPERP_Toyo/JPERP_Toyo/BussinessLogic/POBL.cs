...
namespace Account.BusinessLogic
{
    class POBL : BusinessBase
    {
        ...
        public Int32 Insert(string PurchaseCode, DateTime PIDate, string SrNo, string VoucherNo, DateTime VoucherDate, long VendorID, long DueDays,
                            ...
                            decimal NetAmount, decimal PaidAmount, string Narration, string XmlString, Int64 Cnt, int GodownID, string CC, 
                            string BCC, bool Is_MailSend, int CompId, string CustInvoiceNo,string SGSTAmt,string CGSTAmt,string IGSTAmt)
        {
            SetDefaultException();
            Int32 POID = 0;
            ...
            para.Add("@i_SGSTAmount", SGSTAmt);
            para.Add("@i_CGSTAmount", CGSTAmt);
            para.Add("@i_IGSTAmount", IGSTAmt);
