...
namespace Account.BusinessLogic
{
    class UserBL : BusinessBase
    {
        ...
        public void Insert(int CompId, string Company, string UserName, string Password, string Name,
             string Company_Email, string User_Email, string User_Password, string User_NPassword, string User_Host, string User_Port, string User_ssl, bool Mail_ByUser, string strPrivilegeList)
        {
            SetDefaultException();
        ...
        public void Update(long UserID, int CompId, string Company, string UserName, string Password,string Name,
             string Company_Email, string User_Email, string User_Password, string User_NPassword, string User_Host, string User_Port, string User_ssl, bool Mail_ByUser, string strPrivilegeList)
        {
            SetDefaultException();
            NameValueCollection para = new NameValueCollection();
